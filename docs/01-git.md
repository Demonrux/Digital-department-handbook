...
Теперь Git **отслеживает изменения файлов вашего проекта**. Но, так как вы только создали репозиторий в нём нет вашего кода. Для этого необходимо **создать commit**.
