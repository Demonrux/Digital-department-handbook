...
<img width="1200" height="640" alt="image" src="https://github.com/user-attachments/assets/07e75ac4-490b-452d-83d3-11b0b196a454" />
...
## 2. Установка
Основной интерфейс для работы с Git является **консоль/терминал**. Это не совсем удобно, тем более для новичков, поэтому есть альтернативы с графическим интерфейсом (кнопками, графиками и т.д.). 
...
То есть помощью одного небольшого текстового файла можно:
